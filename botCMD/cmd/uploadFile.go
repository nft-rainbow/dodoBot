...
var uploadFileCmd = &cobra.Command{
	...
	Long: `In order to config the mint service in dodo, the admin of the bot can choose to upload its own file to NFTRainbow server to obtain the file_url through this cmd.`,
